...
case 'ban':
	...
	case 'config_pages':
		...
		$insert = "INSERT INTO `".$_SESSION['prefix'].$table."`(`id`, `name`, `visits`, `active`, `description`, `infos_sup`, `keywords`, `access_groups`, `access_admin`, `config`, `ver`, `date_page`) VALUES
			...
			('', 'contact', 0, 1, NULL, NULL, NULL, NULL, '0', '1|2', 'EMAIL=@', '1.0.0', '2025-04-14 12:27:04'),
			...
			('', 'formation', 0, 1, NULL, NULL, NULL, NULL, '0', '1', '', '1.0.0', '2026-06-22 20:50:15'),
			('', 'test', 0, 1, NULL, NULL, NULL, NULL, '0', '1', '', '1.0.0', '2026-06-27 14:03:09');";
	break;
...
DROP TABLE IF EXISTS `captcha_blacklist`;
CREATE TABLE IF NOT EXISTS `captcha_blacklist` (
  `id` int NOT NULL AUTO_INCREMENT,
  `ip` varchar(45) NOT NULL,
  `reason` varchar(255) NOT NULL,
  `created_at` int NOT NULL,
...
DROP TABLE IF EXISTS `captcha_shield`;
CREATE TABLE IF NOT EXISTS `captcha_shield` (
