...
class AdminPages
{
    ...
    public function render($filename, $menu = array())
    {
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between bookmark-head gap-2">
                        <ul class="nav nav-tabs app-tabs-primary bookmark-app-tab bg-light-primary d-inline-flex b-r-20 p-2 mb-0" role="tablist">
            <?php
            if (!empty($menu)):
                foreach ($menu as $key => $value):
                    ...
                    if (isset($value['ico'])) {
                        $ico = '<i style="margin-right:10px" class="'.$value['ico'].'"></i>';
                    } else {
                        $ico = '<i class="fa-solid fa-house"></i>';
                    }
                    ...
                    ?>
                    <li class="nav-item">
                        <button class="belcms_admin_li_hover nav-link rounded-4 <?= $active; ?>" type="button" onclick="location.href='<?= $value['href']; ?>'">
                            <?= $ico; ?><?= $value['title']; ?>
                        </button>
                    </li>
                    <?php
