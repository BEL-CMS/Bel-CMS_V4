                        ...
                        <div class="card-body p-0">
                            <div class="p-3 kanban-board-head">
                                ...
                                <div class="kanban-content mt-2">
                                    ...
                                    <div class="kanban-task-description op-8 mb-1" style="overflow: hidden;white-space: nowrap;text-overflow: ellipsis;max-width: 550px;"><?= htmlspecialchars_decode($description); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
