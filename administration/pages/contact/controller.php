...
class Contact extends AdminPages
{
    ...
    {
        $menu[] = array('title' => 'Accueil', 'href' => 'contact?Admin&option=pages', 'ico'  => 'fa-solid fa-igloo','active' => 'active');
        $menu[] = array('title' => 'Catégorie', 'href' => 'contact/category?Admin&option=pages', 'ico'  => 'fa-solid fa-layer-group');
        $menu[] = array('title' => 'Configuration', 'href' => 'contact/config?Admin&option=pages', 'ico'  => 'fa-solid fa-user-gear');
    ...
    public function config ()
    {
        $menu[] = array('title' => 'Accueil', 'href' => 'contact?Admin&option=pages', 'ico'  => 'fa-solid fa-igloo');
        $menu[] = array('title' => 'Ajouter', 'href' => 'contact/addnewcat?Admin&option=pages', 'ico'  => 'fa-solid fa-layer-group');
        $menu[] = array('title' => 'Configuration', 'href' => 'contact/config?Admin&option=pages', 'ico'  => 'fa-solid fa-user-gear', 'active' => 'active');
        $this->render('config', $menu);
    }
}