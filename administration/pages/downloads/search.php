                ...
                <div class="card">
                    ...
                    ?>
                        <div class="belcms_content_search">
                            <h2><a href="Downloads/View/<?= $v->id; ?>/<?= Common::removeBlank($v->name); ?>" <?= $v->name; ?>><?= $v->name; ?></a></h2>
                            <?= $v->description; ?>
                    ...
                    endforeach;
                    if (count($dls) == 0) {
                        $msg = 'Aucun élément ne figure dans la base de données.';
                        $Notification =  Notification::infos($msg, 'Aucun téléchargement', );
                    }
                    ?>
                </div>
            </div>
