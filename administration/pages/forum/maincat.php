                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $active; ?></td>
                                        <td>
                                            <button class="btn btn-info label-btn rounded-pill" onclick="location.href='forum/MainCatEdit/<?= $v->id; ?>?admin&option=pages'">
                                                <i class="ri-settings-4-line label-btn-icon me-2"></i>Edition
                                            </button>&nbsp; &nbsp;
                                            <button class="btn btn-danger label-btn label-end rounded-pill" onclick="location.href='forum/MainCatDel/<?= $v->id; ?>?admin&option=pages'">Supprimer
