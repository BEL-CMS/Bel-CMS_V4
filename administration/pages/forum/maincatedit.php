                ...
                <div class="card custom-card">
                    ...
                    <div class="card-header">
                        <div class="card-title">
                            Editer une catégorie principal
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="cattitle" class="form-label">Nom de la catégorie principal</label>
                            <input id="cattitle" value="<?= $forum->title; ?>" type="text" class="form-control" required name="title">
                        </div>
                        <div class="mb-3">
                            <label for="catsubtitle" class="form-label">Sous-titre</label>
                            <input id="catsubtitle" value="<?= $forum->subtitle; ?>" type="text" class="form-control" name="subtitle">
                        </div>
                        <div class="mb-3">
                            ...
                            <input id="caticon" value="<?= $forum->icon; ?>" type="text" class="form-control" name="icon" placeholder="fa-solid fa-house">
                        </div>
                    </div>
