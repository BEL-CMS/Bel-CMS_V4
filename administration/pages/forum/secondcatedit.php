...
?>
<form action="Forum/sendeditseconcat?management&option=pages" method="post">
    <div class="card-body">
        <div class="row">
            <div class="col-xl-12">
                <div class="card custom-card">
                    ...
                    <div class="card-header">
                        <div class="card-title">
                            Editer une catégorie secondaire
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                        ...
                        <div class="form-floating mb-3">
                            <input name="title" required="required" type="text" class="form-control" id="title" value="<?= $data->title; ?>">
                            <label for="title">Titre de la catégorie secondaire</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input name="subtitle" type="text" class="form-control" id="subtitle" value="<?= $data->subtitle; ?>">
                            <label for="subtitle">Sous-titre</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input name="orderby" type="number" min="1" class="form-control" id="orderby" value="<?= $data->orderby; ?>">
                        ...
                        <div class="card-footer">
                            ...
                            <button type="submit" class="btn btn-secondary"><?= constant('EDIT'); ?></button>
                        </div>
                    </div>
                </div>
            </div>
