    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <form action="gallery/sendnewsubcat?management&option=pages" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-3">
                            ...
                            <input class="form-control form-input-color" type="color" name="bg_color">
                        </div>
                        <?php
