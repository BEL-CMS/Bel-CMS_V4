...
<form action="registration/adduser?admin&option=users" method="post">
    <div class="mb-4 mt-4">
        <h5 class="fw-medium mb-0">Ajout d'un utilisateur</h5>
    </div>
            ...
            <div class="row mt-4 justify-content-center">
                <div class="col-md-3">
                    ...
                    <div class="card-footer">
                        <div class="btn-list">
                            <button type="submit" class="btn btn-primary btn-wave">Enregistrer le profil</button>
                        </div>
                    </div>
                </div>
                <div class="col-md-9">
                        ...
                        <div class="tab-pane show active" id="main-profile" role="tabpanel" tabindex="0" aria-labelledby="main-profile-tab">
                                <div class="row gy-4 mb-4">
                                    <div class="col-xl-12">
                                        ...
                                        <input type="text" name="username" class="form-control" id="first-name" placeholder="Nom / Pseudonyme" value="">
                                    </div>
                                    <div class="col-xl-6">
                            ...
                            <form>
                                <div class="row gy-4 mb-4">
                                    <div class="col-xl-6">
                                        ...
                                        <input value="" type="email" name="mail" class="form-control" id="mail" placeholder="e-mail d'enregistrement" required>
                                    </div>
                                    <div class="col-xl-6">
                                        <label for="user-public" class="form-label">E-mail public</label>
                                        <input value="" type="email" name="public_mail" class="form-control" id="user-mail" placeholder="e-mail public">
                                    </div>
                                    <div class="col-xl-12">
                                        <label for="websites" class="form-label">URL</label>
                                        <input type="url" value="" class="form-control" id="websites" placeholder="https://">
                                    </div>
                                </div>
                                <div class="row mb-4">
