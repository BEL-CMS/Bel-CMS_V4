							...
							if (layout == 'full') {
								...
								for (var t = 0; t < events.length; t++) {
									if (typeof events[t] != "undefined") {
										...
										calendar_string += '<div class="event-title ' + event_class + ' color-' + color + '"><a href="#" data="'+shortTitle(events[t].title, 2)+'" class="belcms_tooltip_top"><span>' + shortTitle(events[t].title, 2) + '</span></a></div>';
