							...
							if (layout == 'full') {
								...
								for (var t = 0; t < events.length; t++) {
									if (typeof events[t] != "undefined") {
										...
										calendar_string += '<div class="event-title ' + event_class + ' color-' + color + '"><a href="calendar/list/'+day_counter+'/'+month_num+'/'+year_num+' "quick_events[i].month" data="'+shortTitle(events[t].title, 2)+'" class="belcms_tooltip_top"><span>' + shortTitle(events[t].title, 2) + '</span></a></div>';
								...
								for (var t = 0; t < events.length; t++) {
									if (typeof events[t] != "undefined") {
										var color = events[t].color ? events[t].color : 1;
										calendar_string += '<a href="#" data="'+shortTitle(events[t].title, 2)+'" class="belcms_tooltip_top"><div class="event-mark color-' + color + '"></div></a>';				
									}
								}
							}
						}
