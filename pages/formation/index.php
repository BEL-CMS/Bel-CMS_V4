...
$dataLieu = ($lieu == 'Farciennes') ? 'Rue de la Jeunesse' : 'Rue du Poirier 226 6061 Montignies-sur-Sambre';
?>
<div class="card">
    <form action="formation/send" method="post">
        ...
        <div class="card-body bg-light" style="text-align: initial;">
            <p style="font-size: 14px;">à :: <b><?= $lieu; ?></b>&nbsp;&nbsp;<a class="belcms_tooltip_right" data="<?= $dataLieu; ?>e" style="cursor: pointer;">?</a></p>
            <div class="row mb-3">
