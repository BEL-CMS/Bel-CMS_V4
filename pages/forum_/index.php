        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-3">
              ...
              ?>
              <div class="col">
                <a class="subcat card h-100 border-0" href="forum/category/<?= $sub->id_forum; ?>">
                  <div class="card-body">
                    <h3 class="h6 mb-1"><i class="<?= $sub->icon; ?>"></i> <?= $sub->title; ?></h3>
                    <p class="small text-secondary mb-2"><?= $sub->subtitle; ?></p>
                    <!--
                    <span class="badge bg-primary-subtle text-primary me-2">sujets</span>
                    <span class="badge bg-success-subtle text-success">messages</span>
                    -->
                  </div>
                </a>
              </div>
