...
<div class="row">
    ...
    <div class="col-sm-8">
        <div class="card">
            <div class="card-header">Quelles sont les caractéristiques fondamentales de votre matériel informatique ?</div>
            <div class="card-body">
                <form action="/user/sendMateriel" method="post">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="input-group mb-2">
                                <div class="form-floating">
                                    ...
                                    <label for="tower">Choisir son boitier</label>
                                </div>
                            </div>
                            <div class="input-group mb-2">
                                <div class="form-floating">
                            ...
                            <div class="input-group mb-2">
                                <div class="form-floating">
                                    <select name="size_hdd" class="form-select">
                                        ...
                                        <option value="300 TO">500 TO</option>
                                        <option value="300 TO">RAID-0</option>
                                    </select>
                    ...
                    <div class="row"><input type="submit" value="Enregister"></div>
                </form>
            </div>
        </div>
    </div>
