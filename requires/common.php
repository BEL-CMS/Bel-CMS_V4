...
final class Common
{
    ...
    #########################################
    # Retirer les accents et le vide
    #########################################
    ...
    #	IntlDateFormatter::SHORT (14/08/1987)
    #	IntlDateFormatter::MEDIUM (14 Aout. 1987)
    #	IntlDateFormatter::LONG (14 Aout 1987)
    #	IntlDateFormatter::FULL (vendredi 14 juillet 1987)
    ...
    public static function TransformDate ($date, $d = 'NONE', $t = 'NONE')
    {
        ...
        if (constant('CMS_LANGS') == constant('FRENCH')) {
            $lg = 'fr_FR';
        } else if (constant('CMS_LANGS') == constant('ENGLISH')) {
            $lg = 'en_US';
        } else if (constant('CMS_LANGS') == constant('NETHERLANDS')) {
            $lg = 'nl_NL';
        } else if (constant('CMS_LANGS') == constant('DEUTCH')) {
            $lg = 'de_DE';
        }
    ...
    public static function genererChaineAleatoire($longueur = 30)
    {
    ...
    # Security Upload
    #########################################
    public static function Upload ($name, $dir, $ext = false, $crypt = false)
    {
        if ($_FILES[$name]['error'] != 4) {
            ...
            if ($crypt != false) {
                ...
                $file = Common::genererChaineAleatoire().'.'.$ext; 
                if (!isset($err)):
    ...
    public static function replaceTo ($msg, $original, $to)
    {
        return str_replace($original, $to, $msg);
    }

    public static function nbCountCaractere ($data)
    {
        return strlen($data);
    }
}