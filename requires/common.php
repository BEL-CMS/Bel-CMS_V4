...
final class Common
{
    ...
    */
    ...
    public static function truncate_2($string, $limit)
    {
    ...
    public static function truncate_3($string, $limit, $break=' ', $pad= '…') {
    ...
    public static function encryptDecrypt ($string, $key, $action = true)
    {
        ...
        $secret_iv      = $_SESSION['CONFIG']['CMS_KEY_ADMIN'];
        $key = hash ('sha256', $key);
