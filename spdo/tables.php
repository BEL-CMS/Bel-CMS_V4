...
$tables = array(
    ...
    'TABLE_BELCMS_SHIELD'       => $DB_PREFIX.'captcha_shield',
    'TABLE_CAPTCHA_LOGS'        => $DB_PREFIX.'captcha_log',
    'TABLE_CAPTCHA_BLACKLIST'   => $DB_PREFIX.'captcha_blacklist',  
    ...
    'TABLE_FORBIDEN_WORD'       => $DB_PREFIX.'forbidden_word',
    ...
    'TABLE_GALLERY_SUBCAT'      => $DB_PREFIX.'gallery_sub_cat',
	'TABLE_GALLERY_VOTE'        => $DB_PREFIX.'gallery_vote',
    'TABLE_GAME_RANK'           => $DB_PREFIX.'game_rank',
