...
<html lang="fr">
    <head>
        <!--=============== basic  ===============-->
        <meta charset="UTF-8">
        <title>Zonar - Creative  Responsive Personal Portfolio</title>
        ...
        <!--=============== favicons ===============-->
        <link rel="shortcut icon" href="/templates/bel-cms/images/favicon.ico">
    </head>
    <body>
        <!-- loader   -->
        <div class="loader">
        ...
        <div id="main">
            ...
            <header class="main-header">
                <!-- logo  -->
                <a href="index.html" class="ajax logo-holder"><img src="/templates/bel-cms/images/logo.png" alt=""></a>
                <!-- logo end -->
                <!-- nav-button-wrap-->
            ...
            <div id="wrapper">
                ...
                <!-- navigation menu end  -->	
                <!-- content-->    
                <div class="content full-height" data-pagetitle="Home slideshow">
                    <!-- fs-slider-wrap  -->
                    <div class="video-holder-wrap hero_entry">
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="ms-item_fs fl-wrap">
                                                <div class="bg par-elem"  data-bg="/templates/bel-cms/images/bg/1.jpg"  ></div>
                                            </div>
                                        </div>
                                        <!--ms_item end-->
                                        <!--ms_item-->
                        ...
                        <div class="half-hero-wrap hhw-vis">
                            ...
                            <h1>Sandy Plegas  - <br><span> Web  developer</span> and designer<br>   form <span>USA</span></h1>
                        ...
                        <div class="hero_promo-wrap bot-element2">
                            <div class="hero_promo-title">
                                <h4>Play Story Video</h4>
                                <p>Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</p>
                            </div>
                            <div class="hero_promo-button">
                                <div class="bg" data-bg="images/bg/1.jpg"></div>
                                <div class="overlay"></div>
                                <a href="https://vimeo.com/322246026" class="image-popup"  ><i class="fas fa-play"></i></a>
                            </div>
                        </div>
                        <!--hero_promo-wrap end-->                           
                        <!-- hero-facts-wrap -->
                        ...
                        <!-- hero-facts-wrap  end-->
                        <div class="hero-decor-numb hdn2"><span>40.7143528  </span><span>-74.0059731 </span> <a href="https://www.google.com.ua/maps/" target="_blank" class="hero-decor-numb-tooltip">Based In NewYork</a></div>
                        <div class="fcwc-pagination fcwc-wrap fcwc-wrap2"></div>
                    </div>
                    <!-- fs-slider-wrap end -->
                    <a href="about.html" class="ajax start-btn st2"><span> Start explore <i class="fal fa-long-arrow-right"></i></span></a>
        ...
        <!-- Main end -->
        <!--=============== scripts  ===============-->
        <script   src="/templates/bel-cms/js/jquery.min.js"></script>
